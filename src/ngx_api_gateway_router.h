...
char * ngx_api_gateway_router(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);

ngx_int_t ngx_api_gateway_router_init_conf(ngx_conf_t *cf, ngx_pool_t *pool,
    ngx_http_api_gateway_router_t *router);

ngx_int_t ngx_api_gateway_router_shm_init(ngx_http_api_gateway_router_t *router,
    ngx_http_api_gateway_shctx_t *sh);
...
ngx_int_t ngx_api_gateway_router_set(ngx_http_api_gateway_router_t *router,
    ngx_str_t backend, ngx_str_t api);

ngx_int_t ngx_api_gateway_router_delete(ngx_http_api_gateway_router_t *router,
    ngx_str_t api);
